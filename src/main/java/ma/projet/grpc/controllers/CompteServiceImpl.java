...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    @Override
    public void compteByType(GetComptesByTypeRequest request, StreamObserver<GetComptesByTypeResponse> responseObserver) {
    ...
    public void deleteCompte(DeleteCompteRequest request, StreamObserver<DeleteCompteResponse> responseObserver) {
        boolean success = compteDB.remove(request.getId()) != null;
        responseObserver.onNext(DeleteCompteResponse.newBuilder().setSuccess(success).build());
        responseObserver.onCompleted();
    }
}